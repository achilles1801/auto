  ...
  return (
    <div className=" flex flex-col">
      ...
      <section className="bg-gray-100 p-4 pt-9 flex justify-center items-center w-full" style={{ fontFamily: "'Bebas Neue', cursive" }}>
       ...
       <div className="w-full flex flex-col lg:flex-row items-stretch bg-gray-100">
  {/* Left side with image, hidden on phones and tablets, visible on computers */}
  <div className="hidden lg:flex lg:flex-col w-1/2 px-6 py-0 pb-4">
  <img src="/Car4.jpg" alt="Car Image" className="object-cover w-full rounded-xl" style={{ maxHeight: '700px' }} />
</div>

        {/* Right side with text, centered on phones and tablets */}
        <div className="w-full lg:w-1/2 px-6 py-0 mx-auto pb-4" style={{ fontFamily: "'Poppins', cursive" }}>
          ...
          <div className="mt-10 px-8 py-8 w-full pb-4 max-w-2xl mx-auto bg-white rounded-xl shadow-xl">
