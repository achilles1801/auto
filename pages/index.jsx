  ...
  return (
    <main className="bg-[#E4E4E4] min-h-screen">
      <div className="container mx-auto pt-16 pb-4 px-4 flex justify-between items-start"> {/* Increased padding-top here */}
        ...
        {/* Text container */}
        <div className="w-2/4 p-4 flex flex-col justify-center pt-16 ml-14" style={{ fontFamily: "'Bebas Neue', cursive" }}>
        ...
        {/* Image container */}
        <div className="flex-grow flex justify-end gap-2 absolute right-0">
